...
import mg.meddoc.repositories.PromotionRepository;

@Service
public class PromotionImplementation implements PromotionService{
	...
	@Override
	public Promotion getById(Serializable id) {
		// TODO Auto-generated method stub
	...
	@Override
	public Page<Promotion> getAllPageable(int page, int max, String col, String direction) {
		// TODO Auto-generated method stub
