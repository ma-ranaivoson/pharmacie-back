...
import mg.meddoc.repositories.HoraireRepository;

@Service
public class HoraireImplementation implements HoraireService{
	
	@Autowired
	private HoraireRepository repository;
	
	@Override
	public Horaire save(Horaire entity) {
		// TODO Auto-generated method stub
		return repository.save(entity);
	}

	@Override
	public List<Horaire> saveAll(List<Horaire> entities) {
		// TODO Auto-generated method stub
		return repository.saveAll(entities);
	}

	@Override
	public Horaire getById(Serializable id) {
		// TODO Auto-generated method stub
	...
	@Override
	public Page<Horaire> getAllPageable(int page, int max, String col, String direction) {
		// TODO Auto-generated method stub
