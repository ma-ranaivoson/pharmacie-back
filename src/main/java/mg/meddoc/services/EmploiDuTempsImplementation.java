...
import mg.meddoc.repositories.EmploiDuTempsRepository;

@Service
public class EmploiDuTempsImplementation implements EmploiDuTempsService{
	
	@Autowired
	private EmploiDuTempsRepository repository;
	
	@Override
	public EmploiDuTemps save(EmploiDuTemps entity) {
		// TODO Auto-generated method stub
		return repository.save(entity);
	}

	@Override
	public List<EmploiDuTemps> saveAll(List<EmploiDuTemps> entities) {
		// TODO Auto-generated method stub
		return repository.saveAll(entities);
	}

	@Override
	public EmploiDuTemps getById(Serializable id) {
		// TODO Auto-generated method stub
	...
	@Override
	public Page<EmploiDuTemps> getAllPageable(int page, int max, String col, String direction) {
		// TODO Auto-generated method stub
